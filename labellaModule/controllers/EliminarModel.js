...
const eliminarUsuario = async function (req, res) {
  if (req.user) {
    ...
    try {
      ...
      res
        .status(500)
        .send({ message: "Error al eliminar el usuario", error: error });
    }
  } else {
...
const eliminarActividadProyecto = async function (req, res) {
  if (req.user) {
    ...
    try {
      ...
      res
        .status(200)
        .send({ message: "Actividad de proyecto eliminada correctamente" });
    } catch (error) {
      res
        .status(500)
        .send({
          message: "Error al eliminar la actividad de proyecto",
          error: error,
        });
    }
  } else {
...
const eliminarIncidenteDenuncia = async function (req, res) {
  if (req.user) {
    ...
    try {
      ...
      res
        .status(200)
        .send({ message: "Incidente/denuncia eliminado correctamente" });
    } catch (error) {
      res
        .status(500)
        .send({
          message: "Error al eliminar el incidente/denuncia",
          error: error,
        });
    }
  } else {
...
const verificarCategoria = async function (req, res) {
  if (req.user) {
    var id = req.params["id"];
    try {
      const cantidadSubcategorias = await Model.Subcategoria.countDocuments({
        categoria: id,
      });
      const cantidadIncidentes = await Model.Incidentes_denuncia.countDocuments(
        { categoria: id }
      );
      ...
      res
        .status(500)
        .send({ message: "Error al verificar la categoría", error: error });
    }
  } else {
    res.status(500).send({ message: "Acceso no permitido" });
  }
  ...
  if (req.user) {
    ...
    try {
      ...
      if (eliminarSubcategorias) {
        ...
        await Model.Subcategoria.updateMany(
          { categoria: id },
          { categoria: nuevaCategoria }
        );
        await Model.Incidentes_denuncia.updateMany(
          { categoria: id },
          { categoria: nuevaCategoria }
        );
      }
      ...
      res
        .status(500)
        .send({ message: "Error al eliminar la categoría", error: error });
    }
  } else {
    res.status(500).send({ message: "Acceso no permitido" });
  }
...
const eliminarSubcategoria = async function (req, res) {
  if (req.user) {
    ...
    try {
      ...
      res
        .status(500)
        .send({ message: "Error al eliminar la subcategoría", error: error });
    }
  } else {
    res.status(500).send({ message: "Acceso no permitido" });
  }
...
const eliminarEncargadoCategoria = async function (req, res) {
  if (req.user) {
    ...
    try {
      ...
      res
        .status(200)
        .send({ message: "Encargado de categoría eliminado correctamente" });
    } catch (error) {
      res
        .status(500)
        .send({
          message: "Error al eliminar el encargado de categoría",
          error: error,
        });
    }
  } else {
...
const eliminarRolUsuario = async function (req, res) {
  if (req.user) {
    ...
    try {
      ...
      res
        .status(200)
        .send({ message: "Rol de usuario eliminado correctamente" });
    } catch (error) {
      res
        .status(500)
        .send({ message: "Error al eliminar el rol de usuario", error: error });
    }
  } else {
    res.status(500).send({ message: "Acceso no permitido" });
  }
...
const eliminarPermiso = async function (req, res) {
  if (req.user) {
    ...
    try {
      ...
      res
        .status(500)
        .send({ message: "Error al eliminar el permiso", error: error });
    }
  } else {
    res.status(500).send({ message: "Acceso no permitido" });
  }
...
const eliminarEstadoIncidente = async function (req, res) {
  if (req.user) {
    ...
    try {
      ...
      res
        .status(200)
        .send({ message: "Estado de incidente eliminado correctamente" });
    } catch (error) {
      res
        .status(500)
        .send({
          message: "Error al eliminar el estado de incidente",
          error: error,
        });
    }
  } else {
  ...
  if (req.user) {
    ...
    try {
      ...
      res
        .status(200)
        .send({
          message: "Estado de actividad de proyecto eliminado correctamente",
        });
    } catch (error) {
      res
        .status(500)
        .send({
          message: "Error al eliminar el estado de actividad de proyecto",
          error: error,
        });
    }
  } else {
  ...
  if (req.user) {
    ...
    try {
      ...
      res
        .status(200)
        .send({
          message: "Tipo de actividad de proyecto eliminado correctamente",
        });
    } catch (error) {
      res
        .status(500)
        .send({
          message: "Error al eliminar el tipo de actividad de proyecto",
          error: error,
        });
    }
  } else {
...
const eliminarDireccionGeo = async function (req, res) {
  if (req.user) {
    ...
    try {
      ...
      res
        .status(200)
        .send({ message: "Dirección geográfica eliminada correctamente" });
    } catch (error) {
      res
        .status(500)
        .send({
          message: "Error al eliminar la dirección geográfica",
          error: error,
        });
    }
  } else {
